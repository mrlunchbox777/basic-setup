...
For the current migration direction toward `chezmoi` + `mise` (+ optional `devbox`), see the plan at [`docs/plans/tooling-pivot-migration-plan.md`](docs/plans/tooling-pivot-migration-plan.md).
