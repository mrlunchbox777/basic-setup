...
run-get-source-and-dir() {
  ...
  run_get_source_and_dir_help_string+="    source=\"\${rgsd[@]:0:1}\"\\n"
  run_get_source_and_dir_help_string+="    dir=\"\${rgsd[@]:1:1}\"\\n"
  run_get_source_and_dir_help_string+="  arrays get weird in different shells\\n"
