...
function get_all_versions {
	if [ "$INCLUDE_PRERELEASE_VERSIONS" == true ]; then
		local all_versions="$(git-github-repo-versions -g "https://github.com/helm/helm" -p v -t)"
	else
		local all_versions="$(git-github-repo-versions -g "https://github.com/helm/helm" -p v -s -t)"
	fi
